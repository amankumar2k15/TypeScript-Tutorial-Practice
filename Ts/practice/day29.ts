...
// Q-2 Temperature Converter
// Define a TypeScript class called “Temperature” with a private property _celsius set to 0.
...
// Use the setter to set the temperature in Fahrenheit to 98.6 and then use the getter for Celsius. What celcius value do you expect.